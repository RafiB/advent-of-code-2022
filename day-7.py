        ...
        if line.startswith("$ ls"):
            ...
            while i < len(lines) and not lines[i].startswith("$"):
                ...
                if entry.startswith("dir "):
                    d_name = entry[len("dir "):]
                    d = Dir(d_name, parent=curr_node)
                    curr_node.children.append(d)
                else:
                    str_size, f_name = entry.split(" ")
                    f = File(f_name, int(str_size), parent=curr_node)
                    curr_node.children.append(f)
                i += 1
            ...
            if dir_name == "..":
                ...
                [curr_node] = [d for d in curr_node.children if d.name == dir_name]
            i += 1
